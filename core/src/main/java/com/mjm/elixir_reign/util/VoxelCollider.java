package com.mjm.elixir_reign.util;
 ...
 * @param <T> Any type that you can get a Vector3 position from; must implement HasPosition3D, often {@link com.mjm.elixir_reign.game.Mover}
 */
